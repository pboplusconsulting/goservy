...
<div class='alert alert-danger'> Could not find any result. </div>	
	<div class="text-right">
    	<a href="#" class="btn btn-ru mzero add_user" data-toggle="modal" data-target="#add_new_member">Add New</a>
    </div>
	<?php } ?>			