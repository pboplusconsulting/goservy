...
<div class="table-responsive">
                         ...
                         <form method="post" class="save_print_bill">
							    <table class="table borderless" id="<?php echo $bill_type.$orderData[0]['table_booking_id']; ?>">
								 ...
								 <tr>
									...
									<td></td><td></td>
									<td align="right"><input type="number" class="discount" value="0" min="0" max="<?php echo $billingData->subtotal-1; ?>" class="form-control"></td>
                                <!--    <td></td> -->
								...
								<tr>
									...
									<td></td>
                                    <td></td>
									<td align="right" class="total_bill"><?php echo number_format($billingData->subtotal,2);?></td>
								</tr> 
								...
								foreach($flagData as $fdata){
								 ...
								 <tr class="total_tax">
                                    ...
                                    <td></td>
									<td align="right" class="total_tax_value"><?php echo number_format((($billingData->subtotal*$fdata['tax_percent'])/100),2);?></td>
								 </tr>
								 <?php } ?>
								 ...
								 <tr>
									...
									<td></td>
                                    <td></td>
									<td align="right" class="grossamount"><?php echo number_format($billingData->subtotal+$totalTax,2); ?></td>
								 </tr>
							    </table>
						...
						<thead>
						 ...
						 <?php
							...
							<td><?php echo ($last_bill['amount']-$last_bill['discount'])+$last_bill['tax']; ?></td>
