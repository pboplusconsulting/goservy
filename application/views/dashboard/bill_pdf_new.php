...
<div style=" font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size:11px">
					    <div>
							...
							<div style="text-align: center; margin-bottom:3px">(Clubs Invoice)</div>
							...
							<div>GST No : 05AANCS7744P1ZH</div>
						     ...
						     <table width="100%" cellspacing="0" cellpadding="2">
								 ...
								 <?php } $total_bill=$billingData->subtotal-$discount?>
							     ...
							     <tr>
									...
									<td colspan="2" style="text-align:right"><?php echo number_format($billingData->subtotal,2) ?></td>
								 </tr>
								 <tr>
								...
								foreach($flagData as $fdata){
									$totalTax=$totalTax+($total_bill*$fdata['tax_percent'])/100;
									?>
								 <tr>
								 ...
								 <tr class="spaceUpper">
									...
									<td colspan="2" style="border-top: 1px solid #000000;border-bottom: 3px double #000000; text-align:right"><b><?php echo number_format(($total_bill+$totalTax),2) ?></b></td>
								 </tr>
							    </table>
