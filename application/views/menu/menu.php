...
<span class="search_animation" style="position:fixed; right:1px; top:20px; z-index:9999px;"><input type="text" name="search_meal" class="search_meal" placeholder="Search meal"><i class="fa fa-search"></i></span>
...
<aside class="basket_area out">
  ...
  <form method="post" class="print_order_">
  <div class="proceed_btn">
        	<div class="clearfix">
              <textarea name="remark" rows="1" style="width:225px; padding: 2px 5px; font-size: 12px; border-color: #ddd; box-shadow: 0px 1px 5px #ccc;" class="pull-left" placeholder="Remarks"><?php echo empty($bookTableData->remark)?'':$bookTableData->remark;?></textarea>
