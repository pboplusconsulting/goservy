...
<body>
       <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
		  <tbody>
			<tr>
			  <td align="left" bgcolor="#92d050"><span style="display:block;padding:6px;font-size:22px;color:#fff">GOSERVY FEEDBACK REPORT</span></td>
			</tr>
			<tr>
...
<thead>
    <tr>
      ...
      <th style="border-bottom:1px solid #000000;background-color:#fff2cc;">Are you a Club member?</th>
      <th style="border-bottom:1px solid #000000;background-color:#fff2cc;">If yes, Membership ID</th>
      <th style="border-bottom:1px solid #000000;background-color:#fff2cc;">Else, would you like to have a tour of Club?</th>
      ...
      <th style="border-bottom:1px solid #000000;background-color:#fff2cc;">Would you like to subscribe to Club newsletter?</th>
