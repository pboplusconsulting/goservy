...
<div class="container-fluid">
    ...
    <ul class="text-right list-inline pull-right">
		...
		<li><a href="<?php echo base_url()?>reports"><i class="fa fa-file"></i> <span>Goservy Sales Report</span></a></li>
		<li><a href="<?php echo base_url()?>reports/feedback_report"><i class="fa fa-file"></i> <span>Goservy Feedback Report</span></a></li>
		</ul>
		</li>
